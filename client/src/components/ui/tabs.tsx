  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "hover:text-[var(--neutral-900)] hover:border-b-[var(--neutral-300)]",
        "data-[state=active]:text-[var(--neutral-900)] data-[state=active]:font-medium data-[state=active]:border-b-[var(--navy-800)]",
