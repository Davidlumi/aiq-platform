...
const cardVariants = cva(
  "flex flex-col bg-card text-card-foreground border",
  {
    variants: {
      variant: {
        default:
          "rounded-md border-border shadow-[var(--card-shadow)] gap-0",
        elevated:
          "rounded-lg border-border shadow-[var(--card-shadow)] gap-0",
        sunken:
          "rounded-md border-border bg-muted shadow-[var(--card-inner-shadow)] gap-0",
      },
    },
    defaultVariants: {
      variant: "default",
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-[17px] font-medium leading-[26px] text-card-foreground",
        className
      )}
      {...props}
    />
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-[14px] font-normal leading-[20px] text-muted-foreground",
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "text-sm font-normal leading-[18px] text-muted-foreground",
        className
      )}
      {...props}
    />
...
function CardDivider({ className, ...props }: React.ComponentProps<"hr">) {
  return (
    <hr
      ...
      className={cn("border-0 border-t border-border mx-6", className)}
      {...props}
    />
  );
}
