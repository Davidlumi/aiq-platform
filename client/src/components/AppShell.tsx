    ...
    <div className="flex flex-col h-screen overflow-hidden">
      ...
      <header className="flex items-center h-14 px-4 gap-3 shrink-0 aiq-topbar z-30">
        ...
        <button
          ...
          className="lg:hidden p-2 rounded transition-colors text-foreground/70 hover:text-foreground hover:bg-foreground/8"
        ...
        <div className="hidden md:flex flex-1 max-w-md ml-2">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full h-9 pl-9 pr-4 rounded-lg bg-foreground/5 border border-border text-sm text-foreground placeholder:text-foreground/40 focus:outline-none focus:bg-foreground/8 focus:border-border/80 transition-all"
            />
          </div>
        </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                ...
                aria-label="Account menu"
              >
                <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold shrink-0 bg-primary text-white border border-primary/20">
                  {initials}
                </div>
                <div className="hidden sm:block text-left">
                  <p className="text-sm font-medium leading-none text-foreground">{displayName}</p>
                  <p className="text-xs leading-none mt-0.5 text-foreground/50">{roleLabel}</p>
                </div>
              </button>
            </DropdownMenuTrigger>
