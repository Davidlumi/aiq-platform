  ...
  return (
    <Card className="border-border">
      <CardContent className="p-8 text-center space-y-6">
        <div className="w-16 h-16 rounded-2xl bg-primary/8 border border-primary/20 flex items-center justify-center mx-auto">
        ...
        {JOB_FUNCTIONS.map(({ value, label, icon: Icon }) => (
          ...
          >
            <div className="flex items-center gap-2">
              <Icon className={cn("w-4 h-4 shrink-0", selected === value ? "text-primary" : "text-muted-foreground")} />
