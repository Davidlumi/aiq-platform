...
export const INITIATIVE_LIBRARY: InitiativeDefinition[] = [
  ...
  // ─── Reward-Exclusive Initiatives (8 new) ─────────────────────────────────
  {
    id: "cr_total_reward_statements",
    label: "AI Total Reward Statements",
    description: "Personalised AI-generated total reward statements showing each employee their full compensation package value including benefits, pension, and non-monetary rewards.",
    category: "compensation_reward",
    requiredSubFunctions: ["reward"],
    requiredDataFields: [],
    softFitFactors: [
      { key: "headcount", label: "Organisation size", fieldPath: "sectionA.totalHeadcount", evaluator: "scoreHeadcount", maxScore: 30 },
      { key: "data_quality", label: "Data quality", fieldPath: "sectionC.dataQualityRating", evaluator: "scoreDataQuality", maxScore: 30 },
      { key: "benefits_complexity", label: "Benefits complexity", fieldPath: "sectionA.totalHeadcount", evaluator: "scoreHeadcount", maxScore: 20 },
      { key: "engagement", label: "Employee engagement priority", fieldPath: "sectionF.changeReadiness", evaluator: "scoreChangeReadiness", maxScore: 20 },
    ],
    timeToValueMonths: { min: 2, max: 4 },
    phase: 1,
    caseStudyAnchor: "UK financial services firm (8K employees): 40% increase in benefits awareness, 15% reduction in voluntary attrition attributed to reward visibility.",
    riskFlagKeys: ["poor_data_quality"],
    valueFormulaKey: "cr_total_reward_statements",
    vendorLandscape: ["Benify", "Darwin (Mercer)", "Reward Gateway", "Benefex"],
    prerequisites: ["Benefits data consolidated in HRIS", "Pension provider data feed"],
    coDeployments: ["ee_recognition_rewards", "cr_compensation_recommendations"],
    phaseRationale: "Foundation phase — total reward visibility drives engagement and reduces attrition from perceived under-compensation.",
    y1CostRange: { low: 30, high: 120 },
    hardGates: [
      { type: "field_gt", path: "sectionA.totalHeadcount", value: 500, label: "Organisation has more than 500 employees" },
      { type: "field_includes", path: "sectionB.hrSubFunctions", value: "Reward", label: "Reward in scope" },
  ...
  {
    id: "cr_benefits_optimisation",
    label: "AI Benefits Optimisation Engine",
    description: "Machine learning model analysing benefits utilisation patterns to recommend optimal benefits mix, reducing waste while improving employee satisfaction.",
    category: "compensation_reward",
    requiredSubFunctions: ["reward"],
    requiredDataFields: [],
    softFitFactors: [
      { key: "headcount", label: "Organisation size", fieldPath: "sectionA.totalHeadcount", evaluator: "scoreHeadcount", maxScore: 35 },
      { key: "data_quality", label: "Data quality", fieldPath: "sectionC.dataQualityRating", evaluator: "scoreDataQuality", maxScore: 30 },
      { key: "cost_pressure", label: "Cost optimisation priority", fieldPath: "sectionA.totalHeadcount", evaluator: "scoreHeadcount", maxScore: 20 },
      { key: "change_readiness", label: "Change readiness", fieldPath: "sectionF.changeReadiness", evaluator: "scoreChangeReadiness", maxScore: 15 },
    ],
    timeToValueMonths: { min: 4, max: 8 },
    phase: 2,
    caseStudyAnchor: "UK retail group (30K employees): 12% benefits cost reduction while improving employee satisfaction scores by 8 points.",
    riskFlagKeys: ["poor_data_quality", "complex_regulation_without_legal_review"],
    valueFormulaKey: "cr_benefits_optimisation",
    vendorLandscape: ["Benify", "Zest", "Benefex", "Thomsons Online Benefits"],
    prerequisites: ["12+ months benefits utilisation data", "Benefits provider API access"],
    coDeployments: ["cr_total_reward_statements"],
    phaseRationale: "Optimise phase — requires historical utilisation data to identify patterns and waste.",
    y1CostRange: { low: 40, high: 180 },
    hardGates: [
      { type: "field_gt", path: "sectionA.totalHeadcount", value: 1000, label: "Organisation has more than 1,000 employees" },
      { type: "field_includes", path: "sectionB.hrSubFunctions", value: "Reward", label: "Reward in scope" },
    ],
  ...
  {
    id: "cr_salary_benchmarking_ai",
    label: "AI Salary Benchmarking",
    description: "Real-time AI-powered salary benchmarking using market data feeds, job architecture matching, and predictive compensation trends.",
    category: "compensation_reward",
    requiredSubFunctions: ["reward"],
    requiredDataFields: [],
    softFitFactors: [
      { key: "headcount", label: "Organisation size", fieldPath: "sectionA.totalHeadcount", evaluator: "scoreHeadcount", maxScore: 30 },
      { key: "data_quality", label: "Data quality", fieldPath: "sectionC.dataQualityRating", evaluator: "scoreDataQuality", maxScore: 25 },
      { key: "talent_competition", label: "Talent market competitiveness", fieldPath: "sectionA.totalHeadcount", evaluator: "scoreHeadcount", maxScore: 25 },
      { key: "manager_capability", label: "Manager capability", fieldPath: "sectionI.managerCapabilityForInsights", evaluator: "scoreWeakManagerCapability", maxScore: 20 },
    ],
    timeToValueMonths: { min: 2, max: 4 },
    phase: 1,
    caseStudyAnchor: "Technology company (5K employees): 60% reduction in time-to-offer, 25% improvement in offer acceptance rate through competitive benchmarking.",
    riskFlagKeys: ["poor_data_quality"],
    valueFormulaKey: "cr_salary_benchmarking_ai",
    vendorLandscape: ["Mercer", "Radford (Aon)", "Payscale", "Figures", "Ravio"],
    prerequisites: ["Job architecture or levelling framework", "Market data subscription"],
    coDeployments: ["cr_compensation_recommendations", "cr_pay_equity"],
    phaseRationale: "Foundation phase — benchmarking data is a prerequisite for pay equity and compensation recommendation engines.",
    y1CostRange: { low: 25, high: 100 },
    hardGates: [
      { type: "field_gt", path: "sectionA.totalHeadcount", value: 250, label: "Organisation has more than 250 employees" },
      { type: "field_includes", path: "sectionB.hrSubFunctions", value: "Reward", label: "Reward in scope" },
    ],
    phaseV3: "foundation",
    functionScope: "reward",
  ...
  {
    id: "cr_incentive_modelling",
    label: "AI Incentive Plan Modelling",
    description: "Predictive modelling engine for variable pay and incentive plan design, simulating cost scenarios and behavioural impact before implementation.",
    category: "compensation_reward",
    requiredSubFunctions: ["reward"],
    requiredDataFields: [],
    softFitFactors: [
      { key: "headcount", label: "Organisation size", fieldPath: "sectionA.totalHeadcount", evaluator: "scoreHeadcount", maxScore: 30 },
      { key: "data_quality", label: "Data quality", fieldPath: "sectionC.dataQualityRating", evaluator: "scoreDataQuality", maxScore: 25 },
      { key: "variable_pay_complexity", label: "Variable pay complexity", fieldPath: "sectionA.totalHeadcount", evaluator: "scoreHeadcount", maxScore: 25 },
      { key: "ethics_capability", label: "AI ethics capability", fieldPath: "sectionG.ai_ethics_trust", evaluator: "scoreEthicsCapability", maxScore: 20 },
    ],
    timeToValueMonths: { min: 3, max: 6 },
    phase: 2,
    caseStudyAnchor: "Global pharmaceutical company (40K employees): 20% improvement in sales incentive ROI through AI-optimised plan design.",
    riskFlagKeys: ["complex_regulation_without_legal_review", "poor_data_quality"],
    valueFormulaKey: "cr_incentive_modelling",
    vendorLandscape: ["Anaplan", "Xactly", "Forma.ai", "CaptivateIQ"],
    prerequisites: ["Historical incentive payout data", "Performance data linked to compensation"],
    coDeployments: ["cr_compensation_recommendations"],
    phaseRationale: "Optimise phase — incentive modelling requires historical payout and performance correlation data.",
    y1CostRange: { low: 60, high: 250 },
    hardGates: [
      { type: "field_gt", path: "sectionA.totalHeadcount", value: 2000, label: "Organisation has more than 2,000 employees" },
      { type: "field_includes", path: "sectionB.hrSubFunctions", value: "Reward", label: "Reward in scope" },
  ...
  {
    id: "cr_executive_comp_analytics",
    label: "Executive Compensation Analytics",
    description: "AI-powered executive compensation analysis including peer benchmarking, pay-for-performance alignment, and proxy disclosure preparation.",
    category: "compensation_reward",
    requiredSubFunctions: ["reward"],
    requiredDataFields: [],
    softFitFactors: [
    ...
    timeToValueMonths: { min: 3, max: 5 },
    phase: 2,
    caseStudyAnchor: "FTSE 250 company: 70% reduction in remuneration committee preparation time, full compliance with UK Corporate Governance Code.",
    riskFlagKeys: ["complex_regulation_without_legal_review"],
    valueFormulaKey: "cr_executive_comp_analytics",
    vendorLandscape: ["Mercer", "WTW", "Aon", "Pearl Meyer", "Equilar"],
    prerequisites: ["Executive compensation data", "Peer group defined", "Remuneration committee governance"],
    coDeployments: ["cr_pay_equity", "gv_ai_governance"],
    phaseRationale: "Optimise phase — executive comp analytics requires established governance and peer group data.",
    y1CostRange: { low: 50, high: 200 },
    hardGates: [
      { type: "field_gt", path: "sectionA.totalHeadcount", value: 2000, label: "Organisation has more than 2,000 employees" },
      { type: "field_includes", path: "sectionB.hrSubFunctions", value: "Reward", label: "Reward in scope" },
  ...
  {
    id: "cr_reward_communication_ai",
    label: "AI Reward Communication Platform",
    description: "AI-generated personalised reward communications explaining pay decisions, benefits changes, and total compensation in employee-friendly language.",
    category: "compensation_reward",
    requiredSubFunctions: ["reward"],
    requiredDataFields: [],
    softFitFactors: [
      { key: "headcount", label: "Organisation size", fieldPath: "sectionA.totalHeadcount", evaluator: "scoreHeadcount", maxScore: 30 },
      { key: "change_readiness", label: "Change readiness", fieldPath: "sectionF.changeReadiness", evaluator: "scoreChangeReadiness", maxScore: 30 },
      { key: "manager_capability", label: "Manager capability", fieldPath: "sectionI.managerCapabilityForInsights", evaluator: "scoreWeakManagerCapability", maxScore: 25 },
      { key: "engagement", label: "Employee engagement", fieldPath: "sectionF.changeReadiness", evaluator: "scoreChangeReadiness", maxScore: 15 },
    ],
    timeToValueMonths: { min: 1, max: 3 },
    phase: 1,
    caseStudyAnchor: "UK healthcare trust (12K employees): 55% reduction in pay-related queries to HR, 30% improvement in reward understanding scores.",
    riskFlagKeys: [],
    valueFormulaKey: "cr_reward_communication_ai",
    vendorLandscape: ["Benify", "Reward Gateway", "Staffbase", "Poppulo"],
    prerequisites: ["Compensation data accessible", "Manager communication channels established"],
    coDeployments: ["cr_total_reward_statements", "ee_internal_comms_ai"],
    phaseRationale: "Foundation phase — reward communication is a quick win that builds trust for subsequent reward technology changes.",
    y1CostRange: { low: 20, high: 80 },
    hardGates: [
      { type: "field_gt", path: "sectionA.totalHeadcount", value: 500, label: "Organisation has more than 500 employees" },
      { type: "field_includes", path: "sectionB.hrSubFunctions", value: "Reward", label: "Reward in scope" },
  ...
  {
    id: "cr_gender_pay_gap_reporting",
    label: "AI Gender Pay Gap Analytics",
    description: "Automated gender pay gap analysis and reporting with root-cause decomposition, scenario modelling, and narrative generation for statutory reporting.",
    category: "compensation_reward",
    requiredSubFunctions: ["reward"],
    requiredDataFields: [],
    softFitFactors: [
    ...
    timeToValueMonths: { min: 2, max: 4 },
    phase: 1,
    caseStudyAnchor: "UK employer (250+ employees): 80% reduction in GPG reporting preparation time, actionable root-cause insights driving 3-year closure plan.",
    riskFlagKeys: ["complex_regulation_without_legal_review"],
    valueFormulaKey: "cr_gender_pay_gap_reporting",
    vendorLandscape: ["Gapsquare (XpertHR)", "Syndio", "PayAnalytics", "Mercer"],
    prerequisites: ["Employee gender data", "Compensation data in HRIS"],
    coDeployments: ["cr_pay_equity"],
    phaseRationale: "Foundation phase — statutory requirement for UK employers with 250+ employees; AI accelerates compliance and adds analytical depth.",
    y1CostRange: { low: 15, high: 80 },
    hardGates: [
      { type: "field_gte", path: "sectionA.totalHeadcount", value: 250, label: "Organisation has 250 or more employees" },
      { type: "field_includes", path: "sectionB.hrSubFunctions", value: "Reward", label: "Reward in scope" },
    ],
    phaseV3: "foundation",
    functionScope: "reward",
  ...
  {
    id: "cr_flexible_benefits_ai",
    label: "AI Flexible Benefits Platform",
    description: "AI-powered flexible benefits platform with personalised recommendations, life-event triggers, and predictive enrolment nudges based on employee profiles.",
    category: "compensation_reward",
    requiredSubFunctions: ["reward"],
    requiredDataFields: [],
    softFitFactors: [
      ...
      { key: "data_quality", label: "Data quality", fieldPath: "sectionC.dataQualityRating", evaluator: "scoreDataQuality", maxScore: 25 },
      { key: "change_readiness", label: "Change readiness", fieldPath: "sectionF.changeReadiness", evaluator: "scoreChangeReadiness", maxScore: 25 },
      { key: "engagement", label: "Employee engagement", fieldPath: "sectionF.changeReadiness", evaluator: "scoreChangeReadiness", maxScore: 20 },
    ],
    timeToValueMonths: { min: 4, max: 8 },
    phase: 2,
    caseStudyAnchor: "UK professional services firm (15K employees): 35% increase in benefits enrolment, 20% reduction in benefits administration cost.",
    riskFlagKeys: ["poor_data_quality"],
    valueFormulaKey: "cr_flexible_benefits_ai",
    vendorLandscape: ["Benify", "Zest", "Benefex", "Darwin (Mercer)"],
    prerequisites: ["Benefits provider integrations", "Employee demographic data"],
    coDeployments: ["cr_total_reward_statements", "cr_benefits_optimisation"],
    phaseRationale: "Optimise phase — flexible benefits require established benefits infrastructure and employee data.",
    y1CostRange: { low: 40, high: 160 },
    hardGates: [
      { type: "field_gt", path: "sectionA.totalHeadcount", value: 1000, label: "Organisation has more than 1,000 employees" },
      { type: "field_includes", path: "sectionB.hrSubFunctions", value: "Reward", label: "Reward in scope" },
    ],
