...
export const INITIATIVE_LIBRARY: InitiativeDefinition[] = [
...

  {
    ...
    softFitFactors: [
      ...
      { key: "lms_present", label: "LMS in place", fieldPath: "sectionC.lmsSystem", evaluator: "scoreLmsPresent", maxScore: 25 },
      { key: "workforce_composition", label: "Frontline workforce", fieldPath: "sectionI.workforceComposition", evaluator: "scoreFrontlineComposition", maxScore: 15 },
    ],
    timeToValueMonths: { min: 2, max: 4 },
    phase: 1,
...

  {
    ...
    softFitFactors: [
      ...
      { key: "workforce_composition", label: "Frontline workforce", fieldPath: "sectionI.workforceComposition", evaluator: "scoreFrontlineComposition", maxScore: 25 },
      { key: "business_direction", label: "Business direction", fieldPath: "sectionI.businessDirectionType", evaluator: "scoreGrowthDirection", maxScore: 25 },
      { key: "change_readiness", label: "Change readiness", fieldPath: "sectionF.changeReadiness", evaluator: "scoreChangeReadiness", maxScore: 15 },
    ],
    timeToValueMonths: { min: 2, max: 4 },
...

  {
    ...
    requiredDataFields: [],
    softFitFactors: [
      { key: "workforce_composition", label: "Frontline workforce", fieldPath: "sectionI.workforceComposition", evaluator: "scoreFrontlineComposition", maxScore: 40 },
...

  {
    ...
    requiredDataFields: [],
    softFitFactors: [
      { key: "workforce_composition", label: "Frontline workforce", fieldPath: "sectionI.workforceComposition", evaluator: "scoreFrontlineComposition", maxScore: 35 },
