...
export const UK_REGULATORY_FRAMEWORKS: { id: string; label: string; shortLabel: string; description: string; risk: "high" | "medium" | "low" }[] = [
  ...
  { id: "employment_rights_1996",   label: "Employment Rights Act 2025 (amending ERA 1996)", shortLabel: "Employment Rights Act 2025", description: "ERA 2025 modernises the 1996 base statute, adding worker rights to request human review of AI-assisted employment decisions. AI-assisted performance and workforce planning tools must: (1) allow human review of AI-assisted employment decisions, (2) not undermine statutory rights under either statute, and (3) document AI involvement in employment decisions per the AI Register requirement. Implements alongside existing ERA 1996 protections for dismissal, redundancy, and employment terms.", risk: "high" },
