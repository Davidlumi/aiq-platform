      ...
      choices: [{
        message: {
          content: JSON.stringify({
            ...
            difficulty: 3,
            options: [
              { label: "A", text: "The email uses informal language inappropriate for senior candidates.", outcomeClass: "acceptable", signalDeltas: { quality_control: 0.3 }, eventCodes: ["QC-01"], rationale: "Acceptable but not the most critical issue." },
              ...
              { label: "C", text: "The email is too long and candidates won't read it.", outcomeClass: "weak", signalDeltas: { quality_control: -0.2 }, eventCodes: [], rationale: "Minor cosmetic issue, not the most significant problem." },
              { label: "D", text: "The email doesn't mention remote working options.", outcomeClass: "weak", signalDeltas: { quality_control: -0.1 }, eventCodes: [], rationale: "Not a significant problem for this type of email." },
            ],
